...
;(function(DocsAPI, window, document, undefined) {
    ...
    const VERSION = "5.4.1";
    const FULL_VERSION = "5.4.1-39";
    console.log(`[${new Date().toISOString()}] [OOWrapper] Onlyoffice API v${VERSION} loaded`);
    /*
...
*/
    ...
    function createIframe(config) {
        ...
        const DOCUMENT_SERVER_URL = config.documentServerURL || ""; 
